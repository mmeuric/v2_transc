 ...
 *                           1VS1 id
 *========================================================================**/
// function renderLocal1vs1(player1Name: string, playerId: number) {
// 	const app = document.getElementById("app");
// 	if (!app) return;
// 	app.innerHTML = `
// 	<div class="h-screen flex items-center justify-center">
...
// 			<h2 class="text-3xl font-bold text-white mb-4">1 vs 1 Local</h2>
// 			<p class="text-gray-400 mb-4">Choisis le joueur 2</p>
// 		</div>
// 		<div class="space-y-3">
// 			<button id="login-player2" class="w-full bg-sky-600 hover:bg-sky-700 text-white font-semibold py-2 px-4 rounded-md transition-colors">
// 			S'identifier
// 			</button>
// 			<button id="back-auth" class="w-full bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-md transition-colors">
// 			← Retour
// 			</button>
// 		</div>
// 		</div>
// 	</div>
// 	`;
// 	document.getElementById("login-player2")?.addEventListener("click", () => {
// 	history.pushState({ page: "1vs1-login" }, "", "/1vs1/login");
// 	renderPlayer2Login(player1Name, playerId); // page login joueur 2
// 	});
